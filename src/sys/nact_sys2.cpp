	...
	: NACT(config, game_id)
{
	if (game_id.is(GameId::SDPS_TONO) || game_id.is(GameId::SDPS_KAIZOKU)) {
		box[0] = {0, 40, 8, 598, 271};
	} else if (game_id.is(GameId::PROG_FD)) {
		box[0] = {0, 64, 13, 407, 289};
		box[1] = {0, 24, 298, 111, 390};
		box[2] = {0, 0, 0, 639, 307};
		box[3] = {0, 0, 0, 319, 399};
		box[4] = {0, (16*8), 310, ((77*8)-1), 390};
		box[5] = {0, (4*8), 310, ((76*8)-1), 390};
		box[6] = {0, (2*8), 317, ((56*8)-1), 389};
		box[7] = {15, 64, 13, 407, 289};
		box[8] = {0, 0, 0, 319, 399};
		box[9] = {0, 320, 0, 639, 40};
	}
}
